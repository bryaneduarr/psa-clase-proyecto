...
def grafico_frecuencia_palabras():
    ...
    plt.tight_layout()
    plt.savefig("/root/SistemasAbiertosI/analisis_logs/reportes/logs_grafico.png")
    plt.show()
...
def grafico_tendencia_errores():
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig("/root/SistemasAbiertosI/analisis_logs/reportes/tendencia_errores.png")
    plt.show()
...
def grafico_errores_por_archivo():
    ...
    plt.tight_layout()
    plt.savefig(
        "/root/SistemasAbiertosI/analisis_logs/reportes/errores_por_archivo.png"
    )
    plt.show()
...
def grafico_top_ips():
    ...
    plt.tight_layout()
    plt.savefig("/root/SistemasAbiertosI/analisis_logs/reportes/top_ips.png")
    plt.show()
...
def enviar_correo():
    archivos = [
        "/root/SistemasAbiertosI/analisis_logs/reportes/logs_grafico.png",
        "/root/SistemasAbiertosI/analisis_logs/reportes/tendencia_errores.png",
        "/root/SistemasAbiertosI/analisis_logs/reportes/errores_por_archivo.png",
        "/root/SistemasAbiertosI/analisis_logs/reportes/top_ips.png",
        "/root/SistemasAbiertosI/analisis_logs/reportes/errores_por_usuario.png",
    ]

    destinatario = "saberxshido@gmail.com"
    asunto = "Reporte de Logs"
    cuerpo_mensaje = "Reportes de logs del día"
